...
/**
 * Listener attached to the <b>end</b> event for the <code>S1 Complete</code> BPMN wait point.
 * <p>
 * Updates the existing status entry created by {@link S1CompleteOrNotNeededStartListener}, and notes the S1_COMPLETE message in the additional
 * information.
 */
public class S1CompleteEndListener extends TaskExecutionListener {

    private static final String ADDITIONAL_INFORMATION = "Received S1 Complete";
