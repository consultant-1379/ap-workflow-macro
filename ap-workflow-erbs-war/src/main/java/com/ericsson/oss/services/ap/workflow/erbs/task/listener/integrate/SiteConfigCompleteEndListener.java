...
/**
 * Listener attached to the <b>end</b> event for the <code>Site Config Complete</code> BPMN wait point.
 * <p>
 * Updates the existing status entry on the AP node.
 */
public class SiteConfigCompleteEndListener extends TaskExecutionListener {

    @Override
    public void updateStatus(final String nodeFdn) {
        getStatusEntryManager().notificationReceived(nodeFdn, StatusEntryNames.SITE_CONFIG_COMPLETE.toString());
    }
}
